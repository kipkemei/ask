...
def english_only(text):
    try:
        ...
        pass
        #isaac raise ValidationError('Title may only contain plain text (ASCII) characters')
...
class ShortForm(forms.Form):
    ...
    content = forms.CharField(widget=PagedownWidget, min_length=20, max_length=1500,)
...
def external_post_handler(request):
    ...
    submit = request.GET.get("action")
    digest1 = request.GET.get("digest")
